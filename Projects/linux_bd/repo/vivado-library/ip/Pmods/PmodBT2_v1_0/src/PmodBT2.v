...
//Date        : Wed Mar 23 17:16:58 2016
//Host        : WK116 running 64-bit major release  (build 9200)
//Command     : generate_target PmodBT2.bd
//Design      : PmodBT2
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "PmodBT2,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=PmodBT2,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=4,numReposBlks=4,numNonXlnxBlks=1,numHierBlks=0,maxHierDepth=0,synth_mode=Global}" *) (* HW_HANDOFF = "PmodBT2.hwdef" *) 
module PmodBT2
  ...
  assign AXI_LITE_UART_arready = S_AXI_1_1_ARREADY;
  assign AXI_LITE_UART_awready = S_AXI_1_1_AWREADY;
  assign AXI_LITE_UART_bresp[1:0] = S_AXI_1_1_BRESP;
  assign AXI_LITE_UART_bvalid = S_AXI_1_1_BVALID;
  assign AXI_LITE_UART_rdata[31:0] = S_AXI_1_1_RDATA;
  assign AXI_LITE_UART_rresp[1:0] = S_AXI_1_1_RRESP;
  assign AXI_LITE_UART_rvalid = S_AXI_1_1_RVALID;
  assign AXI_LITE_UART_wready = S_AXI_1_1_WREADY;
  ...
  assign S_AXI_1_1_ARADDR = AXI_LITE_UART_araddr[3:0];
  assign S_AXI_1_1_ARVALID = AXI_LITE_UART_arvalid;
  assign S_AXI_1_1_AWADDR = AXI_LITE_UART_awaddr[3:0];
  assign S_AXI_1_1_AWVALID = AXI_LITE_UART_awvalid;
  assign S_AXI_1_1_BREADY = AXI_LITE_UART_bready;
  assign S_AXI_1_1_RREADY = AXI_LITE_UART_rready;
  assign S_AXI_1_1_WDATA = AXI_LITE_UART_wdata[31:0];
  assign S_AXI_1_1_WSTRB = AXI_LITE_UART_wstrb[3:0];
  assign S_AXI_1_1_WVALID = AXI_LITE_UART_wvalid;
  ...
  PmodBT2_axi_quad_spi_0_0 axi_quad_spi_0
  ...
  PmodBT2_axi_uartlite_0_0 axi_uartlite_0
  ...
  PmodBT2_pmod_bridge_0_0 pmod_bridge_0
       (.in1_O(axi_uartlite_0_UART_TxD),
        ...
        .in4_I(axi_quad_spi_0_SPI_0_SS_I),
        .in4_O(axi_quad_spi_0_SPI_0_SS_O),
        .in4_T(axi_quad_spi_0_SPI_0_SS_T),
        .in5_I(axi_quad_spi_0_SPI_0_IO0_I),
        .in5_O(axi_quad_spi_0_SPI_0_IO0_O),
        .in5_T(axi_quad_spi_0_SPI_0_IO0_T),
        .in6_I(axi_quad_spi_0_SPI_0_IO1_I),
        .in6_O(axi_quad_spi_0_SPI_0_IO1_O),
        .in6_T(axi_quad_spi_0_SPI_0_IO1_T),
        .in7_I(axi_quad_spi_0_SPI_0_SCK_I),
        .in7_O(axi_quad_spi_0_SPI_0_SCK_O),
        .in7_T(axi_quad_spi_0_SPI_0_SCK_T),
